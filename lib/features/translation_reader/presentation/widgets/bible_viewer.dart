...
import 'package:the_smyrna_bible_v2/features/translation_reader/presentation/widgets/bible_finder.dart';
...
class BibleViewer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) =>
          sl<ReaderBloc>()..add(const ReaderReadTranslation('eng-kjv')),
      child: Row(
        children: [
          Expanded(
